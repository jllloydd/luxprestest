          ...
          <ul
            ...
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <a href='javascript:void(0)'
                class="hover:text-amber-700 text-slate-700 block font-medium text-[15px]">HOME</a>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href='javascript:void(0)'
              class="hover:text-amber-700 text-slate-900 block font-medium text-[15px]">LISTINGS</a>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href='javascript:void(0)'
              class="hover:text-amber-700 text-slate-900 block font-medium text-[15px]">LET'S MOVE</a>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href='javascript:void(0)'
              class="hover:text-amber-700 text-slate-900 block font-medium text-[15px]">ABOUT US</a>
            </li>
          </ul>
        </div>
      </div>
